...
class BamlSyncClient:
    ...
    def ReportChapter(self, input: types.ChapterInput,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ReportChapter", args={
                "input": input,
            })
    ...
    def ReportConclusion(self, input: types.ChapterInput,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ReportConclusion", args={
                "input": input,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    def ReportIntroduction(self, input: types.ChapterInput,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ReportIntroduction", args={
                "input": input,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ReportChapter(self, input: types.ChapterInput,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ReportChapter", args={
            "input": input,
        })
    ...
    def ReportConclusion(self, input: types.ChapterInput,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ReportConclusion", args={
            "input": input,
        })
        return baml_py.BamlSyncStream[str, str](
          __result__,
    ...
    def ReportIntroduction(self, input: types.ChapterInput,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ReportIntroduction", args={
            "input": input,
        })
        return baml_py.BamlSyncStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ReportChapter(self, input: types.ChapterInput,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ReportChapter", args={
            "input": input,
        }, mode="request")
        return __result__
    def ReportConclusion(self, input: types.ChapterInput,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ReportConclusion", args={
            "input": input,
        }, mode="request")
        return __result__
    def ReportIntroduction(self, input: types.ChapterInput,
